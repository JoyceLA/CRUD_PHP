...
<html>
	...
	<body>	
			...
			TURNO: <select id = "sel_turno" name="sel_turno" onchange="activarCalendarioAnest(this);" >
			...
			<br/>
			<br/>
			<iframe id="internWindow" src="schedule_anestecia.php?idTurno=0" scrolling="auto" src="" frameborder="0" height="400" width="100%"></iframe>	
		<!--	<div id="div_back">
