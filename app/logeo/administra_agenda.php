...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
	...
	<html xmlns="http://www.w3.org/1999/xhtml">
		<head>
			...
			<link rel="stylesheet" href="estilos/stylecalendar.css" type="text/css" />
						...
						<table id="tbl_ver_agenda"  cellpadding="3" cellspacing="2" border="1">
							...
							<?php
								$result = mysql_query("SELECT num_agenda, fecha, a.id_turno,s.id_servicio, s.nombre,
									...
									diagnostico, cirugia, id_quirofano,realizada from agenda a
								...
								if ($result) {
									...
									for ($i=0; $i<$n; $i++) {
										...
										echo "<td><img class=\"botons\" title=\"Click - Cirugia Realizada\" id=\"btn".$registro[0]."\" src=\"img/paloma.png\" onclick=\"confirmarcirugia(this,document.getElementById('btn1".$registro[0]."'));\"/>
											  <img class=\"botons\" title=\"Cirugia - Cirugia NO realizada\" id=\"btn1".$registro[0]."\" src=\"img/stop.png\" onclick=\"recalendarizarcirugia(this,document.getElementById('btn".$registro[0]."'));\"/></td>";
										echo "</tr>";
								...
								function getSalas($id,$fecha,$serv){
									list($year, $month, $day) = explode('-', $fecha);
									$dia= diaSemana($day,$month,$year);
									$result2 = mysql_query("SELECT DISTINCT num_sala FROM salas WHERE id_servicio=".$serv." AND dia ='".$dia."' ORDER BY num_sala ASC ");
